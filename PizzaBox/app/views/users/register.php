			...
			<section id="wrap_form">
				<div class="form_box">
					...
					<div class="msg">
						...
						<p><?php //echo $data['failed_msg']; ?></p>
						<p><?php echo $data['email_err']; ?></p>
						<p><?php echo $data['name_err']; ?></p>
						<p><?php echo $data['pwd_err']; ?></p>
						<p><?php echo $data['pwdr_err']; ?></p>
					</div>
					<form action="<?php echo URLROOT; ?>/users/register" method="post" id="input_form" class="input_credentials">
					...
					<p class="p_style">Already have an account? Log In <a href="<?php echo URLROOT ?>/users/login">here</a></p>
				</div>
