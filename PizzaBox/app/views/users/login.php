		...
		<main>
			<section id="wrap_form">
				<div class="form_box">
					...
					<form action="<?php echo URLROOT; ?>/users/login" method="post" id="input_form" class="input_credentials">
					...
					<p class="p_style">Don't have an account? Register <a href="<?php echo URLROOT ?>/users/register">here</a></p>
				</div>
			</section>
